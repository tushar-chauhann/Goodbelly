...
export default function CheckoutScreen() {
  ...
  const isAddressServiceable = () => {
    ...
    const locationServiceable = serviceabilityData?.serviceability?.locationServiceAble === true;
    const riderServiceable = serviceabilityData?.serviceability?.riderServiceAble === true;
