...
const CreateAddressModal = ({
  ...
  const handlePredictionSelect = async (placeId) => {
    try {
      ...
      showCustomPopup("Error", "Failed to get location details", "error");
    } finally {
        ...
        >
          <View style={tw`flex-1 bg-black/50 justify-end`}>
            <TouchableOpacity
              ...
              onPress={onClose}
            />
            <View style={tw`bg-white rounded-t-3xl max-h-[90%] w-full`}>
              {/* Header */}
              <View
              ...
              >
                ...
                <View style={tw`px-4 pt-1 pb-2 z-20`}>
                  ...
                  >
                    ...
                    <TextInput
                      ref={searchInputRef}
                      style={tw`flex-1 ml-1 text-sm text-black`}
                        ...
                        {predictions.map((item) => (
                          ...
                          >
                            ...
                            <Text
                              style={[
                                fontStyles.body,
                                tw`text-sm text-gray-700 flex-1`,
                              ]}
                              numberOfLines={1}
                            >
                              {item.description}
