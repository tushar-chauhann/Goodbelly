      ...
      >
        ...
        <View style={{ paddingHorizontal: layout.containerPadding, marginTop: -24 }}>
          ...
          >
            ...
            <View style={tw`flex-row justify-between items-center`}>
              <TouchableOpacity
                ...
                onPress={() => handleCallKitchen(phone)}
                disabled={!phone} // Disable if no phone number
              >
                <FeatherIcon
                  name="phone"
                  size={16}
                  color={phone ? "#6B9080" : "#9CA3AF"}
                />
                <Text
                  style={[
                    fontStyles.bodyBold,
                    tw`ml-1 text-xs`,
                    phone ? tw`text-[#6B9080]` : tw`text-gray-400`,
                  ]}
                >
                  {phone ? phone : "Call Kitchen"}
                </Text>
              </TouchableOpacity>
          ...
          <View style={tw`mb-8`}>
            ...
            {productsLoading ? (
              <View style={tw`flex justify-center items-center py-12`}>
                <ActivityIndicator size="large" color="#6B9080" />
              </View>
            ) : products.length > 0 ? (
              <>
                ...
                {products.length > 6 && (
                  <TouchableOpacity
                    ...
                    style={tw`bg-[#6B9080] rounded-2xl py-4 mt-4 shadow-lg shadow-black/10`}
                  >
                    <Text
                      style={[
                        fontStyles.bodyBold,
              ...
              <View
                style={tw`bg-white rounded-2xl p-8 items-center shadow-lg shadow-black/10`}
              >
                <View
