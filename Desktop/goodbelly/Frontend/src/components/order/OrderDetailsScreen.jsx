    ...
    return (
      <SafeAreaView style={tw`flex-1 bg-white`} edges={["top", "left", "right"]}>
        ...
        <View style={tw`flex-1 justify-center items-center`}>
          ...
          <Text style={[fontStyles.body, tw`mt-4 text-sm text-gray-600`]}>
        ...
        {canCancel && (
          <View style={tw`mt-3`}>
            <TouchableOpacity
              ...
              style={[tw`px-3 py-2 rounded-lg items-center`, { backgroundColor: "#EF4444" }]}
            >
              <Text style={[fontStyles.bodyBold, tw`text-white text-sm`]}>Cancel Order</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
