...
export default function StepConsultation({ formData, updateField, toggleMultiSelect }) {
    ...
    const timeSlotColumns = width >= 768 ? 4 : width >= 375 ? 3 : 2;
    const timeSlotBasis = getColumnBasis(timeSlotColumns);
                                ...
                                <View style={tw`flex-row flex-wrap gap-2 mt-3 justify-center`}>
                                    {SLOT_OPTIONS.map((slot) => (
                                        <TouchableOpacity
                                            ...
                                            style={[
                                                tw`rounded-lg border px-3 py-3 items-center justify-center flex-grow`,
                                                { flexBasis: timeSlotBasis },
                                                isSelected(day, slot)
