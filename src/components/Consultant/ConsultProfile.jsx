...
const ConsultProfile = () => {
  ...
  const initiatePayUPayment = async (bookingData, transactionId) => {
    try {
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      console.log("   REDIRECTING TO WEBSITE FOR PAYMENT (User Request)");
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");

      // As per requirement: Redirect to website instead of in-app PayU
      const url = "https://goodbelly.in/consultations";
      const supported = await Linking.canOpenURL(url);

      if (supported) {
        await Linking.openURL(url);
      } else {
        Alert.alert("Error", "Cannot open website URL: " + url);
      }

    } catch (error) {
      console.error("Error opening website:", error);
      Alert.alert("Error", "Failed to redirect to website");
    }
  };
