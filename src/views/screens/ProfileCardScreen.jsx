...
import { ProfileCardSkeleton } from "../../components/ProductSkeleton";
import { useDispatch } from "react-redux";
import { setUser as setUserRedux } from "../../redux/slicer";
      ...
      try {
        ...
        if (response?.data) {
          ...
          const updatedUser = {
            ...user,
            ...response.data,
            // Ensure preference is always populated from what we sent
            preference: theme,
          };
          setUser(updatedUser);
          await AsyncStorage.setItem("user", JSON.stringify(updatedUser));

          // ✅ Dispatch to Redux so ALL screens (SeeMore, HomeScreen etc.) react immediately
        ...
        >
          ...
          <View style={tw`px-5`}>
            ...
            >
              ...
              >
                To delete your account, please go to Privacy & Policy tab and click on delete account button.
              </Text>
            </View>
          </View>
        </ScrollView>
